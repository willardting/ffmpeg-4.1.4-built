...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --enable-openssl --arch=armv7
prefix=/usr/local
...
CC_IDENT=gcc 8 (Raspbian 8.3.0-6+rpi1)
ARCH=arm
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -lasound
EXTRALIBS-avfilter=-pthread -lm
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lz -L/usr/local/lib -lssl -lcrypto
